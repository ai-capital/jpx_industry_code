  ...
  class << self
    def all
      [
        ...
        { id:  6, jpx_industry_code_category_id:  4, name: 'パルプ・紙',           code: '3150' },
        ...
        { id: 10, jpx_industry_code_category_id:  4, name: 'ゴム製品',             code: '3350' },
        { id: 11, jpx_industry_code_category_id:  4, name: 'ガラス・土石製品',     code: '3400' },
        ...
        { id: 33, jpx_industry_code_category_id: 10, name: 'サービス業',           code: '9050' }
      ]
    end
  end
end
